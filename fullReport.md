...
The benefits of this solution are that once the product is bug tested and operational there will be a free distributeable version of a customizable local encryption program. The program will be useful for those looking to take contents of a file and place them in a text file and be able to encrypt them so that only they are able to know the contents of that file. This adds a layer of protection to that file that contains personal information that could be used against them if someone were to get their hands on it. There are limitations to this program in its first version state like it can only be operated with .txt files so there are restrictions to its operation and its capabilities. However, this is still better than having no encryption on personal information files. Having even a small encryption on it provides time to react to secure information and change passwords that you would not get it there was no encryption at all on the files.
...
2. javax.crypto.CipherInputStream
3. javax.crypto.CipherOutputStream
4. javax.crypto.KeyGenerator
5. javax.crypto.NoSuchPaddingException
6. javax.crypto.SecretKey
7. javax.crypto.spec.SecretKeySpec
8. javax.crypto.SecretKeyFactory
9. javax.crypto.spec.IvParameterSpec
10. javax.crypto.spec.PBEKeySpec
11. javax.crypto.BadPaddingException
12. javax.crypto.Cipher.SECERT_KEY
13. javax.crypto.IllegalBlockSizeException

### Security Libraries
1. java.security.InvalidKeyException
2. java.security.NoSuchAlgorithmException
3. java.security.InvalidAlgorithmParameterException
4. java.security.spec.InvalidKeySpecException
5. java.security.spec.KeySpec

### Senior Project Libraries
1. seniorProject.desEncryption.desFileCreator
2. seniorProject.desEncryption.desFileCreatorDec

### Other Libraries
1. java.sql.Timestamp
2. java.nio.charset.StandardCharsets
